...
.bullet-wrapper.animate-slideIn:nth-child(1) {
  animation-delay: 0.1s;
}

.bullet-wrapper.animate-slideIn:nth-child(2) {
  animation-delay: 0.2s;
}

.bullet-wrapper.animate-slideIn:nth-child(3) {
  animation-delay: 0.3s;
}

.bullet-wrapper.animate-slideIn:nth-child(4) {
  animation-delay: 0.4s;
}

.bullet-wrapper.animate-slideIn:nth-child(5) {
  animation-delay: 0.5s;
}

.bullet-wrapper.animate-slideIn:nth-child(6) {
