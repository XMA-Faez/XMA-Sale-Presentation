    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
      ...
      >
        <div class="text-center">
          ...
          <div class="!text-lg text-rose-900 !font-medium">Total Clients</div>
        </div>
      </div>
      <div 
        v-motion
      ...
      >
        <div class="text-center">
          <div class="!text-4xl !font-bold mb-2 text-rose-500">
            <Ticker :value="30" decimalPlaces="0" color="text-rose-500" />K+
          </div>
          <div class="!text-lg text-rose-900 !font-medium">Leads Generated</div>
        </div>
      </div>
      <div 
        v-motion
      ...
      >
        <div class="text-center">
          <div class="!text-4xl !font-bold mb-2 text-rose-500">
            AED <Ticker :value="3" decimalPlaces="0" color="text-rose-500" />M+
          </div>
          <div class="!text-lg text-rose-900 !font-medium">Ad Budget Managed</div>
        </div>
      </div>
    </div>
  </div>
