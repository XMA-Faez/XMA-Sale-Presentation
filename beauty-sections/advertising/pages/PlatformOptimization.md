  ...
  <div class="max-w-6xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      >
        ...
        <p class="text-rose-900 !text-sm !leading-relaxed">Square & vertical formats, lifestyle-focused, UGC heavy</p>
      </div>
      <div
        v-click="2"
        v-motion
      ...
      >
        ...
        <p class="text-rose-900 !text-sm !leading-relaxed">Clean product shots, benefit-focused copy, search intent</p>
      </div>
      <div
        v-click="3"
        v-motion
      ...
      >
        ...
        <p class="text-rose-900 !text-sm !leading-relaxed">Vertical video, trend-based, authentic feel, quick hooks</p>
      </div>
    </div>
  </div>
</div>
